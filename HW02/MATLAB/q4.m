...
figure(1); surf(x_,x_,class1); hold on; surf(x_,x_,class2); surf(x_,x_,class3); hold off;
figure(2); contour(x_,x_,class1); hold on; contour(x_,x_,class2); contour(x_,x_,class3); grid on; axis tight;
...
axis([a b a/2 b/2]);
xlabel("x_1"); ylabel("x_2"); title("LDA Decition Criteria lines");
...
text(-5.5,4.25,"(Class 1, Class 3) Seperation",fontsize=10);
text(-5.5,3.75,["x2 = " + num2str(m13_) + "*x1 + " + num2str(-m13_*p13(1)+p13(2))],fontsize=8.5);
hold off; 
